...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\muhammad.saif\\Desktop\\tester_sony_digirelax\\psychopy_tut_exercises\\with_code\\simple_targte_distractor.py',
